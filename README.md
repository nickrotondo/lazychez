...
In wide terminals (100+ columns), the file list and git status stack on the left with the diff on the right. In narrow terminals, all three panes stack vertically.
